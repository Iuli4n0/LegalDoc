...
{
    private static readonly float[] ThreeDimEmbedding = [0.1f, 0.2f, 0.3f];
    private static readonly float[] SingleDimEmbedding = [0.1f];
    ...
    public void Given_ValidParameters_When_CreateIsCalled_Then_ChunkIsCreatedCorrectly()
    {
        ...
        var embedding = ThreeDimEmbedding;
    ...
    public void Given_TwoChunksCreated_When_Compared_Then_UniqueIdsAreGenerated()
    {
        ...
        var embedding = SingleDimEmbedding;
    ...
    public void Given_EmptyDocumentId_When_CreateIsCalled_Then_ArgumentExceptionIsThrown()
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            DocumentChunk.Create(Guid.Empty, 0, "Text", SingleDimEmbedding));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            DocumentChunk.Create(Guid.NewGuid(), 0, text!, SingleDimEmbedding));
